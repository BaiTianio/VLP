...
#######调用########
RawData=np.load(r"C:\Users\abc47\Desktop\VLP\Data_Receive_analyze\DataStroge\2020_1_13\(100,-20)_0.npy")
ArrangedData=DataArrange_WithoutSetoff(RawData)
np.save(r"C:\Users\abc47\Desktop\VLP\Data_Receive_analyze\Analyze_Python\数据预处理\2020_1_13整理后的数据\无偏移修正的数据\(100,-20)_0.npy",ArrangedData)