...
class load_data():#用于加载数据
    ...
    def __init__(self):
            root=tk.Tk()
            root.withdraw()
            self.load_path=filedialog.askdirectory(title='加载数据目录!!!look here',initialdir='C:/Users/abc47/Desktop/VLP/RotateVLP/Data_Receive_analyze/Data_Picture/2019_8_23')
